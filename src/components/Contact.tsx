...
export default function Contact() {
  ...
  const inputStyle: React.CSSProperties = { width: '100%', boxSizing: 'border-box' as const, background: 'rgba(0,0,0,0.42)', border: '1px solid rgba(57,255,20,0.25)', color: '#F3F3F3', padding: 16, fontFamily: 'Space Grotesk', fontSize: 14, outline: 'none', borderRadius: 4, transition: 'border-color 0.2s ease, box-shadow 0.2s ease' }
        ...
        <div ref={ref} className="reveal tf24-contact-layout" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'start' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              {[
                { icon: '📍', label: 'Location', value: 'Central Ground, Sector 12' },
                { icon: '📞', label: 'Phone', value: '+91 98765 43210' },
                { icon: '✉', label: 'Email', value: 'hello@turfon24.com' },
              ].map(item => (
                <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                  <span style={{ width: 42, height: 42, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(57,255,20,0.35)', borderRadius: '50%', fontSize: 16, flexShrink: 0 }}>{item.icon}</span>
                  <div>
                    <div style={{ fontFamily: 'Space Grotesk', fontSize: 10, fontWeight: 600, letterSpacing: '0.22em', textTransform: 'uppercase', color: '#39FF14', marginBottom: 2 }}>{item.label}</div>
          ...
          {/* Right — form */}
          <div style={{ position: 'relative', background: 'rgba(7,13,22,0.92)', border: '1px solid rgba(57,255,20,0.22)', borderRadius: 6, padding: '36px 32px' }}>
            ...
            {submitted ? (
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 0', gap: 16 }}>
                <div style={{ width: 56, height: 56, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', border: '2px solid rgba(57,255,20,0.5)', background: 'rgba(57,255,20,0.08)' }}>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: 10 }}>
                    <div style={{ padding: '0 14px', background: 'rgba(0,0,0,0.42)', border: '1px solid rgba(57,255,20,0.25)', borderRadius: 4, fontFamily: 'Space Grotesk', fontSize: 14, color: 'rgba(243,243,243,0.6)', display: 'flex', alignItems: 'center' }}>+91</div>
                    <input
