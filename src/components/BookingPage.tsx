...
import logoMark from '../assets/turfon24-logo-mark.png?url'
...
export default function BookingPage() {
  ...
  return (
    <div style={{ background: '#000000', color: '#F5F5F5', minHeight: '100vh' }}>
      <header
        style={{
          position: 'sticky',
          top: 0,
      ...
      >
        <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64, padding: '0 24px' }}>
          ...
          <a
            ...
            onMouseEnter={e => { e.currentTarget.style.borderColor = '#39F72A'; e.currentTarget.style.color = '#39F72A' }}
      ...
      <div className="container" style={{ padding: '0 24px' }}>
        <div style={{ padding: '40px 0 8px' }}>
          <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 44, textTransform: 'uppercase', letterSpacing: '0.04em', margin: 0 }}>
            Book Your <span style={{ color: '#39F72A' }}>Slot</span>
          </h1>
